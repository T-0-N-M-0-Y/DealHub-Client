...
const Footer = () => {
    return (
      <footer className="bg-gray-100 pt-4 min-h-[65vh] flex flex-col">
        <div className="container mx-auto grid grid-cols-7 gap-4 p-4 flex-grow">
          ...
          <div className="col-span-2">
            <div className="font-bold uppercase text-sm text-center mb-5">Our Location</div>
            <div className="mt-2">
              {/*  map here */}
            </div>
          </div>
        ...
        <div className="bg-black text-sm text-white text-center py-5">
         Copyright &copy; {new Date().getFullYear()} <span className="text-red-500">DealHub</span>. All rights reserved.
        </div>
      </footer>
    );
  };
